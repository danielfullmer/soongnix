...
cts_error_prone_rules = java_defaults {
...
cts_error_prone_rules_tests = java_defaults {
...
cts_support_defaults = java_defaults {
...
in { inherit cts_defaults cts_error_prone_rules cts_error_prone_rules_tests cts_support_defaults; }
