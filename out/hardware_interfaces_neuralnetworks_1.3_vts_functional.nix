...
VtsHalNeuralNetworksV1_3_utils = cc_library_static {
...
VtsHalNeuralnetworksV1_3TargetTest = cc_test {
...
in { inherit VtsHalNeuralNetworksV1_3_utils VtsHalNeuralnetworksV1_3TargetTest; }
