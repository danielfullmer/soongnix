...
py3-interp-defaults = cc_defaults {
...
py3-launcher-defaults = cc_defaults {
...
py3-launcher-lib = cc_library_static {
...
py3-launcher-autorun = cc_binary {
...
py3-c-modules = cc_library_static {
    name = "py3-c-modules";
    defaults = ["py3-interp-defaults"];
    cflags = [
...
in { inherit py3-c-modules py3-cmd py3-interp py3-interp-defaults py3-launcher py3-launcher-autorun py3-launcher-defaults py3-launcher-lib; }
