{ android_library_import, java_genrule_host, java_import_host, java_library_host }:
let

"robolectric-accessibility-test-framework-2.1" = java_import_host {
...
"robolectric-ant-1.8.0" = java_import_host {
    name = "robolectric-ant-1.8.0";
    jars = ["repository/org/apache/ant/ant/1.8.0/ant-1.8.0.jar"];
};

"robolectric-compile-testing-0.15" = java_import_host {
...
robolectric-sqlite4java-import = java_import_host {
...
robolectric-sqlite4java-native = java_genrule_host {
...
"robolectric-sqlite4java-0.282" = java_library_host {
