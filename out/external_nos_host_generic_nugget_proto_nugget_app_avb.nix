...
"nos_app_avb_service_genc++" = genrule {
...
"nos_app_avb_service_genc++_headers" = genrule {
...
"nos_app_avb_service_genc++_mock" = genrule {
...
in { inherit "nos_app_avb_service_genc++" "nos_app_avb_service_genc++_headers" "nos_app_avb_service_genc++_mock" nos_app_avb; }
