...
compatibility-tradefed = java_library_host {
    ...
    srcs = [
        ...
        "src/com/android/compatibility/common/tradefed/targetprep/DeviceInteractionHelperInstaller.java"
        ...
        "src/com/android/compatibility/common/tradefed/targetprep/VtsDeviceInfoCollector.java"
