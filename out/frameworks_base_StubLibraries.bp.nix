{ droidstubs, filegroup, java_defaults, java_library_static, stubs_defaults }:
let
...
metalava-base-api-stubs-default = stubs_defaults {
...
metalava-full-api-stubs-default = stubs_defaults {
...
metalava-non-updatable-api-stubs-default = stubs_defaults {
...
api-stubs-docs-non-updatable = droidstubs {
...
system-api-stubs-docs-non-updatable = droidstubs {
...
module-lib-api-stubs-docs-non-updatable = droidstubs {
...
module-lib-api-stubs-docs = droidstubs {
...
android_defaults_stubs_current = java_defaults {
...
android_monolith_stubs_current = java_library_static {
...
android_merged_stubs_current = java_library_static {
...
android_system_monolith_stubs_current = java_library_static {
...
android_system_merged_stubs_current = java_library_static {
...
android_module_lib_stubs_current = java_library_static {
...
android_non_updatable_stubs_current = java_library_static {
...
android_system_non_updatable_stubs_current = java_library_static {
...
"frameworks-base-api-system-current.txt" = filegroup {
...
"frameworks-base-api-system-removed.txt" = filegroup {
