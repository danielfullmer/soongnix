{ cc_defaults, cc_library_shared, gensrcs }:
let

rs_support_defaults = cc_defaults {
...
rs_generated_headers_support = gensrcs {
...
rs_generated_sources_support = gensrcs {
...
libRSSupport = cc_library_shared {
    name = "libRSSupport";
