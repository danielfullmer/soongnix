{ cc_binary_host, cc_library_host_static, cc_library_static, cc_test, cc_test_library, genrule }:
let

libnetd_test_resolv_utils = cc_test_library {
...
golddata_proto_host = cc_library_host_static {
...
resolv_gold_test_pbtxt2pb_host = cc_binary_host {
...
resolv_gold_test_pbtxt2pb = genrule {
    ...
    srcs = [
        "testdata/getaddrinfo.tls.topsite.google.pbtxt"
        "testdata/getaddrinfo.topsite.amazon.pbtxt"
        "testdata/getaddrinfo.topsite.bing.pbtxt"
        "testdata/getaddrinfo.topsite.ebay.pbtxt"
        "testdata/getaddrinfo.topsite.facebook.pbtxt"
        "testdata/getaddrinfo.topsite.google.pbtxt"
        "testdata/getaddrinfo.topsite.netflix.pbtxt"
        "testdata/getaddrinfo.topsite.reddit.pbtxt"
        "testdata/getaddrinfo.topsite.wikipedia.pbtxt"
        "testdata/getaddrinfo.topsite.yahoo.pbtxt"
        "testdata/getaddrinfo.topsite.youtube.pbtxt"
        "testdata/gethostbyname.tls.topsite.youtube.pbtxt"
        "testdata/gethostbyname.topsite.youtube.pbtxt"
    ];
...
golddata_proto = cc_library_static {
    name = "golddata_proto";
...
resolv_stats_test_utils = cc_test_library {
...
resolv_stats_test_utils_test = cc_test {
...
in { inherit golddata_proto golddata_proto_host libnetd_test_resolv_utils resolv_gold_test resolv_gold_test_pbtxt2pb resolv_gold_test_pbtxt2pb_host resolv_integration_test resolv_stats_test_utils resolv_stats_test_utils_test resolv_stress_test; }
