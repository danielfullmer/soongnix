...
libcpu_features-utils = cc_library {
...
libcpu_features-unix_based_hardware_detection = cc_library {
...
cpu_features-test-defaults = cc_defaults {
...
libcpu_features-string_view = cc_test_library {
...
libcpu_features-filesystem_for_testing = cc_test_library {
...
libcpu_features-hwcaps_for_testing = cc_test_library {
...
stack_line_reader-defaults = cc_defaults {
...
libcpu_features-stack_line_reader = cc_test_library {
...
libcpu_features-stack_line_reader_for_test = cc_test_library {
...
libcpu_features-all_libraries = cc_test_library {
...
cpu_features-bit_utils_test = cc_test {
...
cpu_features-string_view_test = cc_test {
...
cpu_features-stack_line_reader_test = cc_test {
...
cpu_features-unix_features_aggregator_test = cc_test {
...
cpu_features-cpuinfo_test = cc_test {
