...
tv-common = android_library {
    ...
    srcs = [
        ...
        "src/com/android/tv/common/experiments/ExperimentFlag.java"
        "src/com/android/tv/common/experiments/ExperimentLoader.java"
        "src/com/android/tv/common/experiments/Experiments.java"
        "src/com/android/tv/common/feature/BuildTypeFeature.java"
        "src/com/android/tv/common/feature/CommonFeatures.java"
        "src/com/android/tv/common/feature/ExperimentFeature.java"
        ...
        "src/com/android/tv/common/flags/ConcurrentDvrPlaybackFlags.java"
        ...
        "src/com/android/tv/common/flags/has/HasConcurrentDvrPlaybackFlags.java"
        ...
        "src/com/android/tv/common/flags/impl/DefaultConcurrentDvrPlaybackFlags.java"
