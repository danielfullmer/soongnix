{ aidl_interface, cc_defaults, cc_library, cc_library_headers, cc_library_static, cc_test, filegroup, genrule }:
let
...
libnetd_resolv_internal_headers = cc_library_headers {
    name = "libnetd_resolv_internal_headers";
    export_include_dirs = ["."];
};

dnsproxyd_protocol_headers = cc_library_headers {
...
resolv_test_defaults = cc_defaults {
...
resolv_test_mts_coverage_defaults = cc_defaults {
...
resolv_test_config_template = filegroup {
...
in { inherit "statslog_resolv.cpp" "statslog_resolv.h" dnsproxyd_protocol_headers dnsresolver_aidl_interface libnetd_resolv libnetd_resolv_headers libnetd_resolv_internal_headers libstatslog_resolv resolv_test_config_template resolv_test_defaults resolv_test_mts_coverage_defaults resolv_unit_test stats_proto; }
