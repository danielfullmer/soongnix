{ cc_binary, cc_defaults, cc_library, cc_prebuilt_library_shared }:
let
...
computepipe_face_runner = cc_binary {
...
libfacegraph = cc_prebuilt_library_shared {
    name = "libfacegraph";
    strip = {
        keep_symbols = true;
    };
...
computepipe_face_tracker = cc_binary {
...
libcomputepipeface-defaults = cc_defaults {
...
libcomputepipefaceproto = cc_library {
...
in { inherit computepipe_face_runner computepipe_face_tracker libcomputepipeface-defaults libcomputepipefaceproto libfacegraph; }
