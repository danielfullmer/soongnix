...
libctsos_jni_defaults = cc_defaults {
...
libctsos_jni = cc_library_shared {
    name = "libctsos_jni";
...
libctsos_jni_arm = cc_library_static {
...
in { inherit libctsos_jni libctsos_jni_arm libctsos_jni_defaults; }
