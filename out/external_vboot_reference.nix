{ cc_binary_host, cc_defaults, cc_library_host_static, filegroup, genrule }:
let
...
libvboot_util = cc_library_host_static {
    name = "libvboot_util";
...
in { inherit futility-host futility_cmds futility_srcs libvboot_util vboot_defaults; }
