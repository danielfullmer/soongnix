{ droidstubs, filegroup, java_library }:
let
...
updatable-media-srcs-without-aidls = filegroup {
...
mediasession2-srcs-without-aidls = filegroup {
...
updatable-media-stubs = droidstubs {
...
updatable_media_stubs = java_library {
...
in { inherit framework_media_annotation mediaplayer2-srcs mediasession2-srcs mediasession2-srcs-without-aidls updatable-media updatable-media-srcs updatable-media-srcs-without-aidls updatable-media-stubs updatable_media_stubs; }
