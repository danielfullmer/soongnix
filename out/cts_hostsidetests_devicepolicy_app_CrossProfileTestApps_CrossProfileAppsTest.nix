...
CtsCrossProfileAppsTests = android_test_helper_app {
    ...
    srcs = [
        "src/com/android/cts/crossprofileappstest/AdminReceiver.java"
        "src/com/android/cts/crossprofileappstest/CrossProfileAppsNonTargetUserTest.java"
        "src/com/android/cts/crossprofileappstest/CrossProfileAppsPermissionToInteractTest.java"
        ...
        "src/com/android/cts/crossprofileappstest/CrossProfileSameTaskLauncherActivity.java"
