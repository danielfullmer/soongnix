...
libmediabenchmark_decoder = cc_library_static {
...
libmediabenchmark_codec2_decoder = cc_library_static {
...
in { inherit libmediabenchmark_codec2_decoder libmediabenchmark_decoder; }
