...
"audio.primary.default" = cc_library_shared {
...
#  The format of the name is audio.<type>.<hardware/etc>.so where the only
#  required type is 'primary'. Other possibilites are 'a2dp', 'usb', etc.
"audio.stub.default" = cc_library_shared {
...
#  new implementations.
"audio_policy.stub" = cc_library_shared {
...
in { inherit "audio.primary.default" "audio.stub.default" "audio_policy.stub"; }
