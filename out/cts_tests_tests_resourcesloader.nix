...
CtsResourcesLoaderTests = android_test {
    ...
    srcs = [
        "src/android/content/res/loader/cts/ResourcesLoaderFallthroughTest.kt"
        "src/android/content/res/loader/cts/ResourcesLoaderTestBase.kt"
        "src/android/content/res/loader/cts/ResourcesLoaderValuesTest.kt"
        "src/android/content/res/loader/cts/Utils.kt"
    ];
    libs = [
...
CtsResourcesLoaderTests_Providers = java_genrule {
...
in { inherit CtsResourcesLoaderTests CtsResourcesLoaderTests_Providers; }
