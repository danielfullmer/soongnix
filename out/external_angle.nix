{ android_app, android_library, cc_defaults, cc_genrule, cc_library_shared, cc_library_static, filegroup, java_defaults }:
let
...
libfeature_support_angle = cc_library_shared {
    generated_headers = [
        "angle_commit_id"
    ];
...
angle_libEGL_egl_loader = cc_defaults {
...
libEGL_angle = cc_library_shared {
    generated_headers = [
        "angle_commit_id"
...
libGLESv1_CM_angle = cc_library_shared {
    generated_headers = [
        "angle_commit_id"
        "angle_spvtools_core_enums_unified1"
        "angle_spvtools_core_tables_unified1"
...
angle_vulkan_entry_points = cc_defaults {
...
angle_vulkan_memory_allocator = cc_defaults {
...
angle_vk_mem_alloc_wrapper = cc_defaults {
...
angle_spvtools_val = cc_library_static {
    generated_headers = [
        "angle_spvtools_core_enums_unified1"
        "angle_spvtools_core_tables_unified1"
        "angle_spvtools_generators_inc"
...
angle_spvtools_vendor_tables_spv-amd-shader-trinary-minmax = cc_genrule {
...
angle_spvtools_vendor_tables_spv-amd-shader-explicit-vertex-parameter = cc_genrule {
...
angle_spvtools_vendor_tables_spv-amd-shader-ballot = cc_genrule {
...
angle_spvtools_vendor_tables_spv-amd-gcn-shader = cc_genrule {
...
"angle_spvtools_vendor_tables_opencl.debuginfo.100" = cc_genrule {
...
angle_spvtools_vendor_tables_debuginfo = cc_genrule {
...
angle_spvtools_opencl_tables_opencl1-0 = cc_genrule {
...
angle_spvtools_language_header_debuginfo = cc_genrule {
...
angle_spvtools_language_header_cldebuginfo100 = cc_genrule {
...
angle_spvtools_headers = cc_defaults {
...
angle_spvtools_glsl_tables_glsl1-0 = cc_genrule {
...
angle_spvtools_generators_inc = cc_genrule {
...
angle_spvtools_core_tables_unified1 = cc_genrule {
...
angle_spvtools_core_enums_unified1 = cc_genrule {
...
angle_spvtools = cc_library_static {
    generated_headers = [
        "angle_spvtools_core_enums_unified1"
        "angle_spvtools_core_tables_unified1"
        "angle_spvtools_generators_inc"
...
angle_spvtools_opt = cc_library_static {
    generated_headers = [
        "angle_spvtools_core_enums_unified1"
        "angle_spvtools_core_tables_unified1"
        "angle_spvtools_generators_inc"
...
angle_glslang_sources = cc_defaults {
    generated_headers = [
        "angle_spvtools_core_enums_unified1"
        "angle_spvtools_core_tables_unified1"
        "angle_spvtools_generators_inc"
...
angle_glslang_default_resource_limits_sources = cc_defaults {
    generated_headers = [
        "angle_spvtools_core_enums_unified1"
        "angle_spvtools_core_tables_unified1"
        "angle_spvtools_generators_inc"
...
angle_glslang_wrapper = cc_defaults {
    generated_headers = [
        "angle_commit_id"
        "angle_spvtools_core_enums_unified1"
        "angle_spvtools_core_tables_unified1"
...
angle_vulkan_backend = cc_defaults {
    generated_headers = [
        "angle_commit_id"
        "angle_spvtools_core_enums_unified1"
        "angle_spvtools_core_tables_unified1"
...
angle_preprocessor = cc_library_static {
    generated_headers = [
        "angle_commit_id"
    ];
...
angle_translator = cc_library_static {
    generated_headers = [
        "angle_commit_id"
    ];
...
angle_translator_headers = cc_defaults {
...
angle_libANGLE_headers = cc_defaults {
    generated_headers = [
        "angle_commit_id"
    ];
...
angle_image_util_headers = cc_defaults {
    generated_headers = [
        "angle_commit_id"
    ];
...
angle_image_util = cc_library_static {
    generated_headers = [
        "angle_commit_id"
    ];
...
angle_vulkan_headers = cc_defaults {
...
angle_gpu_info_util = cc_library_static {
    generated_headers = [
        "angle_commit_id"
    ];
...
angle_system_utils = cc_defaults {
...
angle_common = cc_library_static {
    generated_headers = [
        "angle_commit_id"
    ];
    name = "angle_common";
...
angle_libANGLE_base = cc_defaults {
    generated_headers = [
        "angle_commit_id"
        "angle_spvtools_core_enums_unified1"
        "angle_spvtools_core_tables_unified1"
...
libGLESv2_angle = cc_library_shared {
    generated_headers = [
        "angle_commit_id"
        "angle_spvtools_core_enums_unified1"
        "angle_spvtools_core_tables_unified1"
...
ANGLE_java_defaults = java_defaults {
    jni_libs = [
        "libEGL_angle"
        "libGLESv1_CM_angle"
        "libGLESv2_angle"
