{ cc_binary_host, cc_defaults, cc_library_static, filegroup, genrule }:
let
...
wayland_core_protocol = filegroup {
...
wayland_version_header = genrule {
...
wayland_scanner = cc_binary_host {
...
wayland_core_protocol_sources = genrule {
...
wayland_core_client_protocol_headers = genrule {
...
wayland_core_server_protocol_headers = genrule {
...
in { inherit libwayland_client libwayland_server wayland_core_client_protocol_headers wayland_core_protocol wayland_core_protocol_sources wayland_core_server_protocol_headers wayland_defaults wayland_scanner wayland_version_header; }
