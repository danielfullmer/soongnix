...
VtsHalWifiSupplicantV1_1TargetTestUtil = cc_library_static {
...
VtsHalWifiSupplicantV1_1TargetTest = cc_test {
...
in { inherit VtsHalWifiSupplicantV1_1TargetTest VtsHalWifiSupplicantV1_1TargetTestUtil; }
