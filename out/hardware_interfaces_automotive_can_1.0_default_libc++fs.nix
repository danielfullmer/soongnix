...
"android.hardware.automotive@libc++fsdefaults" = cc_defaults {
...
"android.hardware.automotive@libc++fs" = cc_library_static {
...
in { inherit "android.hardware.automotive@libc++fs" "android.hardware.automotive@libc++fsdefaults"; }
