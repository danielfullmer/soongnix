{ art_cc_library, art_cc_test, cc_defaults, cc_library_headers, genrule, gensrcs, libart_cc_defaults, libart_static_cc_defaults }:
let
...
libart_static_base_defaults = libart_static_cc_defaults {
...
libart_static_defaults = cc_defaults {
...
libartd_static_defaults = cc_defaults {
...
libart-runtime-gtest = art_cc_library {
