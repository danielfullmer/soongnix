{ cc_binary, cc_binary_host, cc_library_host_static, cc_library_static }:
let
...
#  Static library.
#  =================================================
breakpad_client = cc_library_static {
...
#  =================================================
libdisasm = cc_library_host_static {
    name = "libdisasm";
    target = {
        darwin = {
            enabled = false;
...
#  =================================================
minidump_stackwalk = cc_binary_host {
...
in { inherit breakpad_client core2md dump_syms libdisasm minidump_stackwalk sym_upload; }
