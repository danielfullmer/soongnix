...
libcodec2_internal = cc_library_headers {
...
libcodec2-impl-defaults = cc_defaults {
...
in { inherit libcodec2-impl-defaults libcodec2-internal-defaults libcodec2_internal libcodec2_vndk; }
