...
"android.hardware.secure_element@1.1_defaults" = cc_defaults {
...
"android.hardware.secure_element@1.0_defaults" = cc_defaults {
...
"android.hardware.secure_element@1.0-service" = cc_binary {
...
"android.hardware.secure_element@1.0-service-disabled" = cc_binary {
...
"android.hardware.secure_element@1.1-service" = cc_binary {
...
"android.hardware.secure_element@1.1-service-disabled" = cc_binary {
