{ aidl_interface, cc_test_library, genrule, phony }:
let
...
hidl2aidl_test_gen_aidl = genrule {
...
hidl2aidl_test_gen = aidl_interface {
    name = "hidl2aidl_test_gen";
    unstable = true;
    srcs = [":hidl2aidl_test_gen_aidl"];
};

hidl2aidl_test_comp_cc = cc_test_library {
...
in { inherit hidl2aidl_test hidl2aidl_test_comp_cc hidl2aidl_test_gen hidl2aidl_test_gen_aidl; }
