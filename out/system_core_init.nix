{ cc_benchmark, cc_binary, cc_defaults, cc_library_static, cc_test, genrule }:
let
...
in { inherit generated_stub_builtin_function_map host_init_verifier init_benchmarks init_defaults init_second_stage init_tests libinit; }
