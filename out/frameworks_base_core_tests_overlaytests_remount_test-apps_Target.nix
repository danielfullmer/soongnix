...
OverlayRemountedTest_Target = android_test_helper_app {
...
OverlayRemountedTest_TargetUpgrade = android_test_helper_app {
...
in { inherit OverlayRemountedTest_Target OverlayRemountedTest_TargetUpgrade; }
