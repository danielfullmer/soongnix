...
collector-device-lib = java_library {
    ...
    srcs = [
        ...
        "java/android/device/collectors/BinderListener.java"
        ...
        "java/android/device/collectors/PwrStatsUtilListener.java"
        ...
        "java/android/device/collectors/ShowmapSnapshotListener.java"
