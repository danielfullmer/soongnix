...
lib-test-profile-text-protos = java_genrule {
...
LongevityPlatformLibTests = android_test {
    ...
    srcs = [
        "src/android/platform/test/longevity/LongevityClassRunnerTest.java"
...
in { inherit LongevityPlatformLibTests lib-test-profile-text-protos; }
