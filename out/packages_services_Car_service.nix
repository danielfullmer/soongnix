...
car-service-common-util-static-lib = java_library {
...
# ####################################################################################
car-service-test-static-lib = android_library {
...
# ####################################################################################
car-service-test-lib = android_library {
...
in { inherit CarService car-service-common-util-static-lib car-service-test-lib car-service-test-static-lib statslog-Car-java-gen; }
