...
ml_nn_cache_libs_defaults = cc_defaults {
...
ml_nn_cache_libs_defaults_android_host = cc_defaults {
...
in { inherit ml_nn_cache_libs_defaults ml_nn_cache_libs_defaults_android_host; }
