{ cc_defaults, cc_library_shared, cc_library_static, cc_test }:
let
...
libunwind_defaults = cc_defaults {
...
libunwind_core_defaults = cc_defaults {
...
libunwind = cc_library_shared {
    name = "libunwind";
    defaults = ["libunwind_core_defaults"];
};

libunwind_static = cc_library_static {
...
# -----------------------------------------------------------------------
libunwindbacktrace = cc_library_static {
...
in { inherit libunwind libunwind-unit-tests libunwind_core_defaults libunwind_defaults libunwind_static libunwindbacktrace; }
