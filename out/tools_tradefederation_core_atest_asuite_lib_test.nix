...
asuite_metrics_lib_tests = python_test_host {
...
asuite_metrics_lib_py3_tests = python_test_host {
...
asuite_cc_lib_tests = python_test_host {
...
asuite_cc_lib_py3_tests = python_test_host {
...
in { inherit asuite_cc_lib_py3_tests asuite_cc_lib_tests asuite_metrics_lib_py3_tests asuite_metrics_lib_tests; }
