...
common-platform-scenario-tests = java_library_static {
    ...
    srcs = [
        ...
        "src/android/platform/test/scenario/performancelaunch/hermeticapp/OpenEmptyActivityMicrobenchmark.java"
        "src/android/platform/test/scenario/performancelaunch/hermeticapp/OpenEmptyWebViewActivityMicrobenchmark.java"
        "src/android/platform/test/scenario/performancelaunch/hermeticapp/OpenManyConfigResourceActivityMicrobenchmark.java"
        "src/android/platform/test/scenario/performancelaunch/hermeticapp/OpenSimpleSurfaceGLActivityMicrobenchmark.java"
        "src/android/platform/test/scenario/profile/CommonUserProfileTest.java"
        "src/android/platform/test/scenario/sample/SampleMicrobenchmark.java"
