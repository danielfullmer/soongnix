{ cc_binary, cc_binary_host, cc_defaults, cc_library_shared, cc_library_static, cc_prebuilt_binary, cc_test, filegroup, genrule }:
let
...
libupdate_engine_aidl = filegroup {
...
#  ========================================================
#  Protobufs.
update_metadata-protos_exports = cc_defaults {
    name = "update_metadata-protos_exports";

    shared_libs = ["libprotobuf-cpp-lite"];
};

update_metadata-protos = cc_library_static {
...
libpayload_consumer_exports = cc_defaults {
...
libpayload_consumer = cc_library_static {
...
libupdate_engine_boot_control_exports = cc_defaults {
...
libupdate_engine_android_exports = cc_defaults {
...
libupdate_engine_android = cc_library_static {
...
#  recovery image.
update_engine_sideload = cc_binary {
...
#  ========================================================
libupdate_engine_client = cc_library_shared {
...
update_engine_client = cc_binary {
...
#  for any client code.
libpayload_generator_exports = cc_defaults {
...
libpayload_generator = cc_library_static {
...
delta_generator = cc_binary_host {
...
ue_unittest_delta_generator = cc_test {
...
#  ========================================================
#  Main unittest file.
update_engine_unittests = cc_test {
...
#  ========================================================
brillo_update_payload = cc_prebuilt_binary {
...
things_update_engine_aidl = filegroup {
