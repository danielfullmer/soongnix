...
"android.hardware.camera.provider@2.6-impl-google" = cc_library_shared {
...
"android.hardware.camera.provider@2.6-service-google" = cc_binary {
...
"android.hardware.camera.provider@2.6-service-google-lazy" = cc_binary {
...
in { inherit "android.hardware.camera.provider@2.6-impl-google" "android.hardware.camera.provider@2.6-service-google" "android.hardware.camera.provider@2.6-service-google-lazy" camera_service_defaults; }
