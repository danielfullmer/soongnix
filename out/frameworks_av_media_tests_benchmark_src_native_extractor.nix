...
libmediabenchmark_extractor = cc_library_static {
...
libmediabenchmark_codec2_extractor = cc_library_static {
...
in { inherit libmediabenchmark_codec2_extractor libmediabenchmark_extractor; }
