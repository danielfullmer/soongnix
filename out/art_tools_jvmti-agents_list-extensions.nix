...
listextensions-defaults = cc_defaults {
...
liblistextensions = art_cc_library {
    name = "liblistextensions";
    defaults = ["listextensions-defaults"];
};

liblistextensionsd = art_cc_library {
...
in { inherit liblistextensions liblistextensionsd listextensions-defaults; }
