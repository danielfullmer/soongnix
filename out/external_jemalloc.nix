...
# -----------------------------------------------------------------------
libjemalloc_jet = cc_library_static {
...
# -----------------------------------------------------------------------
libjemalloc_unittest = cc_library_static {
...
# -----------------------------------------------------------------------
libjemalloc_integrationtest = cc_library_static {
...
jemalloc_integrationtests = cc_test {
...
in { inherit jemalloc_defaults jemalloc_integrationtests jemalloc_unittests libjemalloc libjemalloc_integrationtest libjemalloc_jet libjemalloc_unittest; }
