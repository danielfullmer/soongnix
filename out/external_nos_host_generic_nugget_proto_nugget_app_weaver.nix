...
"nos_app_weaver_service_genc++" = genrule {
...
in { inherit "nos_app_weaver_service_genc++" "nos_app_weaver_service_genc++_headers" "nos_app_weaver_service_genc++_mock" nos_app_weaver; }
