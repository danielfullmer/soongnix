{ rust_library_dylib, rust_library_rlib, rust_prebuilt_dylib }:
let

libstd_x86_64-unknown-linux-gnu = rust_prebuilt_dylib {
...
libtest_x86_64-unknown-linux-gnu = rust_prebuilt_dylib {
...
"libcore.rust_sysroot" = rust_library_rlib {
...
"libbacktrace_sys.rust_sysroot" = rust_library_rlib {
...
"librustc_demangle.rust_sysroot" = rust_library_rlib {
...
"libbacktrace_rs.rust_sysroot" = rust_library_rlib {
...
"libcompiler_builtins.rust_sysroot" = rust_library_rlib {
...
"liblibc.rust_sysroot" = rust_library_rlib {
...
"liballoc.rust_sysroot" = rust_library_rlib {
...
"libcfg_if.rust_sysroot" = rust_library_rlib {
...
"libpanic_abort.rust_sysroot" = rust_library_rlib {
...
"libpanic_unwind.rust_sysroot" = rust_library_rlib {
...
"libunwind.rust_sysroot" = rust_library_rlib {
...
"libhashbrown.rust_sysroot" = rust_library_rlib {
...
"libstd.static" = rust_library_rlib {
    name = "libstd.static";
    deny_warnings = false;
    crate_name = "std";
    edition = "2018";
...
"libterm.static" = rust_library_rlib {
    name = "libterm.static";
    deny_warnings = false;
    crate_name = "term";
    srcs = [rustc + "/src/libterm/lib.rs"];
...
"libgetopts.static" = rust_library_rlib {
...
libunicode_width = rust_library_rlib {
...
"libunicode_width.static" = rust_library_rlib {
...
"libtest.static" = rust_library_rlib {
    name = "libtest.static";
    deny_warnings = false;
    crate_name = "test";
    srcs = [rustc + "/src/libtest/lib.rs"];
