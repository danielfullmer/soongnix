...
loganalysis = java_library_host {
    ...
    srcs = [
        ...
        "src/com/android/loganalysis/item/GenericTimingItem.java"
        ...
        "src/com/android/loganalysis/item/SystemServicesTimingItem.java"
        ...
        "src/com/android/loganalysis/parser/TimingsLogParser.java"
