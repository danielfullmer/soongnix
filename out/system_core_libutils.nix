...
libutils_headers = cc_library_headers {
...
libutils_singleton_test = cc_test {
...
libutils_test_singleton1 = cc_test_library {
...
libutils_test_singleton2 = cc_test_library {
