...
swiftshader_spvtools_generate_grammar_tables = genrule {
...
swiftshader_spvtools_generate_language_headers = genrule {
    ...
    cmd = "$(location) --extinst-name=DebugInfo --extinst-grammar=$(location source/extinst.debuginfo.grammar.json) --extinst-output-base=$$(dirname $(location DebugInfo.h))/DebugInfo; " +
...
swiftshader_spvtools_generate_registry_tables = genrule {
...
swiftshader_spvtools_update_build_version = genrule { #  FIXME this relies on `git` which is no good on build machines
...
swiftshader_spirv-tools = cc_library_static {
...
in { inherit swiftshader_spirv-tools swiftshader_spvtools_generate_grammar_tables swiftshader_spvtools_generate_language_headers swiftshader_spvtools_generate_registry_tables swiftshader_spvtools_update_build_version; }
