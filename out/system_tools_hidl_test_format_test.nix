{ genrule, hidl_package_root, phony }:
let
...
hidl_format_test_pkg = hidl_package_root {
    name = "hidl_format_test_pkg";
};

hidl_format_test = phony {
...
in { inherit hidl_format_test hidl_format_test_diff hidl_format_test_pkg; }
