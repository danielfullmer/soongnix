...
libnativebridge6-dummy = cc_library_shared {
...
libnativebridge6prezygotefork = cc_library_shared {
...
in { inherit libnativebridge-api-tests libnativebridge-dummy libnativebridge-dummy-defaults libnativebridge-lazy-tests libnativebridge-tests libnativebridge-tests-defaults libnativebridge2-dummy libnativebridge3-dummy libnativebridge6-dummy libnativebridge6prezygotefork; }
