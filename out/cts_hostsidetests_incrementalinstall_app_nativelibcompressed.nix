...
libcompressednativeincrementaltest = cc_test_library {
...
IncrementalTestAppCompressedNativeLib = android_test_helper_app {
...
in { inherit IncrementalTestAppCompressedNativeLib libcompressednativeincrementaltest; }
