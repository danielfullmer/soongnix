...
fluoride_service_defaults = cc_defaults {
...
#  ========================================================
bt-example-hr-server = cc_binary {
...
libbluetoothtbd_hal = cc_library_static {
...
in { inherit bluetooth-cli bluetoothtbd bluetoothtbd_test bt-example-hr-server fluoride_service_defaults libbluetoothtbd_hal; }
