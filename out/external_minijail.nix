{ cc_binary, cc_defaults, cc_genrule, cc_library, cc_library_static, cc_object, cc_test }:
let
...
in { inherit drop_privs libminijail libminijail_flags libminijail_gen_constants libminijail_gen_constants_obj libminijail_gen_syscall libminijail_gen_syscall_obj libminijail_generated libminijail_test libminijail_unittest_gtest minijail0 minijail0_cli_unittest_gtest mj_system_unittest_gtest mj_util_unittest_gtest syscall_filter_unittest_gtest; }
