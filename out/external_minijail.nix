{ cc_binary, cc_defaults, cc_genrule, cc_library, cc_library_static, cc_object, cc_test, rust_library_host_rlib }:
let
...
#  =========================================================
libminijail_gen_syscall_obj = cc_object {
...
libminijail_gen_syscall = cc_genrule {
...
libminijail_gen_constants_obj = cc_object {
...
libminijail_gen_constants = cc_genrule {
...
libminijail_generated = cc_library_static {
...
libminijail_gen_constants_llvmir = cc_object {
...
libminijail_gen_syscall_llvmir = cc_object {
...
#  =========================================================
libminijail_unittest_gtest = cc_test {
...
#  =========================================================
syscall_filter_unittest_gtest = cc_test {
...
#  =========================================================
mj_system_unittest_gtest = cc_test {
...
#  =========================================================
mj_util_unittest_gtest = cc_test {
...
#  =========================================================
minijail0_cli_unittest_gtest = cc_test {
...
libminijail_sys = rust_library_host_rlib {
...
in { inherit drop_privs libminijail libminijail_flags libminijail_gen_constants libminijail_gen_constants_llvmir libminijail_gen_constants_obj libminijail_gen_syscall libminijail_gen_syscall_llvmir libminijail_gen_syscall_obj libminijail_generated libminijail_sys libminijail_test libminijail_unittest_gtest minijail0 minijail0_cli_unittest_gtest mj_system_unittest_gtest mj_util_unittest_gtest syscall_filter_unittest_gtest; }
