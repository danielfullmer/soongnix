...
CtsIsolatedSplitAppFeatureA = android_test_helper_app {
    ...
    srcs = [
        "src/com/android/cts/isolatedsplitapp/feature_a/FeatureAActivity.java"
        "src/com/android/cts/isolatedsplitapp/feature_a/FeatureAReceiver.java"
    ];
...
in { inherit CtsIsolatedSplitAppFeatureA; }
