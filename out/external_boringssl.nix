{ cc_binary, cc_defaults, cc_library, cc_library_static, cc_test }:
let
...
libcrypto_no_clang = cc_library_static {
...
libssl_static = cc_library_static {
    name = "libssl_static";
    defaults = [
        "libssl_sources"
        "boringssl_defaults"
...
in { inherit boringssl_crypto_test boringssl_defaults boringssl_flags boringssl_ssl_test boringssl_test_support bssl cavp libcrypto libcrypto_defaults libcrypto_no_clang libcrypto_static libssl libssl_static; }
