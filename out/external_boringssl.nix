{ blueprint_go_binary, bootstrap_go_package, cc_binary, cc_defaults, cc_library, cc_library_static, cc_object, cc_test, package }:
let
...
boringssl_defaults = cc_defaults {
...
# // libcrypto
libcrypto_defaults = cc_defaults {
...
bssl_fipscommon = bootstrap_go_package {
...
bssl_inject_hash = blueprint_go_binary {
...
libcrypto_static = cc_library_static {
...
boringssl_test_support = cc_library_static {
...
in { inherit _missingName bcm_object boringssl_crypto_test boringssl_defaults boringssl_flags boringssl_ssl_test boringssl_test_support bssl bssl_ar bssl_fipscommon bssl_inject_hash cavp libcrypto libcrypto_defaults libcrypto_static libssl test_fips; }
