...
statsd-config-protos = java_genrule {
    ...
    srcs = [
        ...
        "res/statsd-configs/cpu-cluster-time/cpu-cluster-time-run-level.pb"
        "res/statsd-configs/cpu-cluster-time/cpu-cluster-time-test-level.pb"
        "res/statsd-configs/cpu-time-per-freq/cpu-time-per-freq-run-level.pb"
        "res/statsd-configs/cpu-time-per-freq/cpu-time-per-freq-test-level.pb"
        "res/statsd-configs/cpu-time-per-thread-freq/cpu-time-per-thread-freq-run-level.pb"
        "res/statsd-configs/cpu-time-per-thread-freq/cpu-time-per-thread-freq-test-level.pb"
        "res/statsd-configs/cpu-time-per-uid-freq/cpu-time-per-uid-freq-run-level.pb"
        "res/statsd-configs/cpu-time-per-uid-freq/cpu-time-per-uid-freq-test-level.pb"
        ...
        "res/statsd-configs/mobile-bytes-transfer/mobile-bytes-transfer-run-level.pb"
        "res/statsd-configs/mobile-bytes-transfer/mobile-bytes-transfer-test-level.pb"
        ...
        "res/statsd-configs/process-cpu-time/process-cpu-time-run-level.pb"
        "res/statsd-configs/process-cpu-time/process-cpu-time-test-level.pb"
        ...
        "res/statsd-configs/subsystem-sleep-state/subsystem-sleep-state-run-level.pb"
        "res/statsd-configs/subsystem-sleep-state/subsystem-sleep-state-test-level.pb"
