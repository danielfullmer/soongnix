...
header-checker-defaults = cc_defaults {
...
header-abi-dumper = cc_binary_host {
...
header-abi-linker-defaults = cc_defaults {
...
header-abi-linker = cc_binary_host {
...
header-abi-diff = cc_binary_host {
...
libheader-checker = cc_library_host_static {
...
header-checker-unittests = cc_test_host {
...
in { inherit header-abi-diff header-abi-dumper header-abi-linker header-abi-linker-defaults header-checker-defaults header-checker-unittests libheader-checker merge-abi-diff; }
