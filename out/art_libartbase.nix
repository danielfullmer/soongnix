{ art_cc_library, art_cc_test, cc_defaults, cc_library_headers, gensrcs }:
let
...
libartbase_defaults = cc_defaults {
...
libartbase_static_base_defaults = cc_defaults {
...
libartbase-art-gtest = art_cc_library {
...
art_libartbase_headers = cc_library_headers {
