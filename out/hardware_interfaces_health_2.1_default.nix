...
"android.hardware.health@2.1-impl-defaults" = cc_defaults {
...
"android.hardware.health@2.1-impl" = cc_library_shared {
...
"android.hardware.health@2.1-service" = cc_binary {
...
in { inherit "android.hardware.health@2.1-impl" "android.hardware.health@2.1-impl-defaults" "android.hardware.health@2.1-service"; }
