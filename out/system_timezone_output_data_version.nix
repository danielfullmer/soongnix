{ prebuilt_etc, prebuilt_usr_share, prebuilt_usr_share_host }:
let
...
tz_version_host = prebuilt_usr_share_host {
...
tz_version-art-test-tzdata = prebuilt_etc {
...
in { inherit tz_version tz_version-art-test-tzdata tz_version_host; }
