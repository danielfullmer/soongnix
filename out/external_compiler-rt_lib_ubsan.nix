...
libubsan_cxx = cc_library_static {
    name = "libubsan_cxx";
    host_supported = true;
...
libclang_rt_ubsan_defaults = cc_defaults {
...
libubsan_standalone = cc_library_host_static {
...
libubsan_standalone_cxx = cc_library_host_static {
...
in { inherit libclang_rt_ubsan_defaults libubsan libubsan_cxx libubsan_standalone libubsan_standalone_cxx; }
