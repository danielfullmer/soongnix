...
JniSafeRegisterNativeMethods_test = cc_test {
...
libnativehelper_api_test = cc_test {
...
in { inherit JniInvocation_test JniSafeRegisterNativeMethods_test libnativehelper_api_test; }
