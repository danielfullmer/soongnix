...
VtsHalDriverDefaults = cc_defaults {
...
VtsHalProfilerDefaults = cc_defaults {
...
in { inherit VtsHalDriverDefaults VtsHalLibDefaults VtsHalProfilerDefaults; }
