{ cc_binary_host, cc_defaults, cc_library_host_shared, cc_library_host_static, cc_test_host, genrule }:
let
...
#  ==========================================================
libaapt2 = cc_library_host_static {
    name = "libaapt2";
    srcs = [
...
#  ==========================================================
libaapt2_jni = cc_library_host_shared {
    name = "libaapt2_jni";
...
in { inherit aapt2 aapt2-protos aapt2_defaults aapt2_tests libaapt2 libaapt2_jni; }
