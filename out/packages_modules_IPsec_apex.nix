...
"com.android.ipsec-defaults" = apex_defaults {
...
in { inherit "com.android.ipsec" "com.android.ipsec-defaults" "com.android.ipsec.certificate" "com.android.ipsec.key"; }
