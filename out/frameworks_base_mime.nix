{ filegroup, java_defaults, java_genrule, java_library }:
let
...
mimemap-defaults = java_defaults {
...
"mimemap-testing-res.jar" = java_genrule {
...
"mime.types.minimized" = filegroup {
...
"android.mime.types.minimized" = java_genrule {
...
"vendor.mime.types.minimized" = java_genrule {
...
in { inherit "android.mime.types.minimized" "mime.types.minimized" "mimemap-res.jar" "mimemap-testing-res.jar" "vendor.mime.types.minimized" mimemap mimemap-defaults mimemap-testing; }
