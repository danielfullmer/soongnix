...
derive_sdk-defaults = cc_defaults {
...
"derive_sdk.rc" = prebuilt_etc {
    name = "derive_sdk.rc";
    src = "derive_sdk.rc";
    installable = false;
};

in { inherit "derive_sdk.rc" derive_sdk derive_sdk-defaults derive_sdk_prefer32; }
