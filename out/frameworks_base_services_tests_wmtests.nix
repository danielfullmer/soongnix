...
WmTests = android_test {
    ...
    srcs = [
        ...
        "src/com/android/server/wm/AnimatingAppWindowTokenRegistryTest.java"
        ...
        "src/com/android/server/wm/AppWindowThumbnailTest.java"
        ...
        "src/com/android/server/wm/BoundsAnimationControllerTests.java"
        ...
        "src/com/android/server/wm/DockedStackDividerControllerTests.java"
        ...
        "src/com/android/server/wm/PinnedStackControllerTest.java"
        ...
        "src/com/android/server/wm/TaskStackContainersTests.java"
        ...
        "src/com/android/server/wm/WindowContainerControllerTests.java"
        ...
        "src/com/android/server/wm/WindowTraceBufferTest.java"
