{ cc_defaults, cc_library, cc_library_headers, force_build_llvm_components_defaults, llvm_defaults, llvm_tblgen }:
let

llvm-defaults = cc_defaults {
    name = "llvm-defaults";
...
llvm-defaults-no-generated-headers = llvm_defaults {
...
llvm-headers-no-generated-headers = cc_library_headers {
...
llvm-headers = cc_library_headers {
    name = "llvm-headers";
    vendor_available = true;
    host_supported = true;
    header_libs = ["llvm-headers-no-generated-headers"];
...
force_build_llvm_components = force_build_llvm_components_defaults {
...
in { inherit force_build_llvm_components libLLVM_android llvm-defaults llvm-defaults-no-generated-headers llvm-gen-attributes llvm-gen-intrinsics llvm-headers llvm-headers-no-generated-headers; }
