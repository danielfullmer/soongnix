{ cc_binary, cc_binary_host, cc_defaults, cc_library_host_static, cc_test_host }:
let
...
libfastboot2 = cc_library_host_static {
    name = "libfastboot2";
...
fastboot_host_defaults = cc_defaults {
...
libfastboot = cc_library_host_static {
    name = "libfastboot";
...
in { inherit fastboot fastboot_defaults fastboot_host_defaults fastboot_test fastbootd libfastboot libfastboot2; }
