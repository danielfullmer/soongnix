...
libmediabenchmark_encoder = cc_library_static {
...
libmediabenchmark_codec2_encoder = cc_library_static {
...
in { inherit libmediabenchmark_codec2_encoder libmediabenchmark_encoder; }
