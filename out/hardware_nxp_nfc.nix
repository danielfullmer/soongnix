...
"android.hardware.nfc@1.1-service" = cc_binary {
...
"android.hardware.nfc@1.2-service" = cc_binary {
...
in { inherit "android.hardware.nfc@1.1-service" "android.hardware.nfc@1.2-service" nfc_nci_nxp nxp_nfc_defaults; }
