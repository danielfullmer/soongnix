...
unsupportedappusage-annotation-processor-lib = java_library_host {
...
in { inherit unsupportedappusage-annotation-processor unsupportedappusage-annotation-processor-lib; }
