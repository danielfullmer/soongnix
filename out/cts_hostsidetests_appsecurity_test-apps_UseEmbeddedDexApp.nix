...
CtsUseEmbeddedDexApp_Canonical = android_test_helper_app {
    name = "CtsUseEmbeddedDexApp_Canonical";
    defaults = ["cts_support_defaults"];
    use_embedded_dex = true;
    srcs = ["src/com/android/cts/useembeddeddex/DummyActivity.java"];
    sdk_version = "current";
    min_sdk_version = "27";
    test_suites = [
        "cts"
...
CtsUseEmbeddedDexApp_DexCompressed = android_test_helper_app {
...
CtsUseEmbeddedDexApp_NotPreferred = android_test_helper_app {
...
CtsUseEmbeddedDexAppSplit_Canonical = android_test_helper_app {
    ...
    #  for split).
    use_embedded_dex = true;
    srcs = ["feature_split/src/com/android/cts/useembeddeddex/feature_x/DummyActivity.java"];
    sdk_version = "current";
    min_sdk_version = "27";
    test_suites = [
        "cts"
...
CtsUseEmbeddedDexAppSplit_CompressedDex = android_test_helper_app {
...
in { inherit CtsUseEmbeddedDexAppSplit_Canonical CtsUseEmbeddedDexAppSplit_CompressedDex CtsUseEmbeddedDexApp_Canonical CtsUseEmbeddedDexApp_DexCompressed CtsUseEmbeddedDexApp_NotPreferred; }
