...
android-support-multidex-version = genrule {
...
android-support-multidex = java_library_static {
...
in { inherit android-support-multidex android-support-multidex-version; }
