...
#
"ProductStrategies.xml" = prebuilt_etc {
...
buildstrategiesstructure_gen = genrule {
...
in { inherit "ProductStrategies.xml" "parameter-framework.policy" _missingName audio_policy_pfw_structure_files audio_policy_pfw_toplevel buildstrategiesstructure_gen domaingeneratorpolicyrule_gen edd_files; }
