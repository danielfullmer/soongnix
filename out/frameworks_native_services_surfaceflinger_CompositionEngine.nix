...
libcompositionengine_defaults = cc_defaults {
...
libcompositionengine = cc_library {
...
libcompositionengine_mocks = cc_library {
...
libcompositionengine_test = cc_test {
...
in { inherit libcompositionengine libcompositionengine_defaults libcompositionengine_mocks libcompositionengine_test; }
