...
common-platform-scenarios = java_library_static {
    ...
    srcs = [
        ...
        "src/android/platform/test/scenario/annotation/FixedApp.java"
        ...
        "src/android/platform/test/scenario/generic/OpenApps.java"
        ...
        "src/android/platform/test/scenario/performancelaunch/hermeticapp/OpenEmptyActivity.java"
        "src/android/platform/test/scenario/performancelaunch/hermeticapp/OpenEmptyWebViewActivity.java"
        "src/android/platform/test/scenario/performancelaunch/hermeticapp/OpenManyConfigResourceActivity.java"
        "src/android/platform/test/scenario/performancelaunch/hermeticapp/OpenSimpleSurfaceGLActivity.java"
        "src/android/platform/test/scenario/performancelaunch/hermeticapp/PerformanceBase.java"
        "src/android/platform/test/scenario/sample/PrintListener.java"
        "src/android/platform/test/scenario/sample/SampleTest.java"
