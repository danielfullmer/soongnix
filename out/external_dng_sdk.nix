...
libdng_sdk-defaults = cc_defaults {
...
libdng_sdk_validate = cc_library_static {
...
dng_validate_host = cc_binary_host {
...
in { inherit dng_validate dng_validate_host libdng_sdk libdng_sdk-defaults libdng_sdk_validate; }
