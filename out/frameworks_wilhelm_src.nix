...
libOpenSLESUT = cc_library_static {
    name = "libOpenSLESUT";
...
libopensles_helper = cc_library_static {
...
libOpenMAXAL = cc_library_shared {
    name = "libOpenMAXAL";
...
in { inherit libOpenMAXAL libOpenSLES libOpenSLESUT libopensles_helper libwilhelm; }
