...
native_bridge_guest_linker_headers = cc_library_headers {
...
native_bridge_guest_linker = cc_binary {
...
in { inherit native_bridge_guest_linker native_bridge_guest_linker_headers; }
