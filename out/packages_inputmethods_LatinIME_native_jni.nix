{ cc_library, cc_library_static, cc_test, filegroup }:
let
...
LATIN_IME_CORE_SRC_FILES = filegroup {
...
liblatinime_static_for_unittests = cc_library_static {
...
in { inherit LATIN_IME_CORE_SRC_FILES libjni_latinime liblatinime_static_for_unittests liblatinime_unittests; }
