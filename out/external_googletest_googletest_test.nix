...
gtest_test_defaults = cc_defaults {
...
gtest_ndk_test_defaults = cc_defaults {
...
googletest-param-test-test = cc_test {
...
gtest_ndk_tests_no_main = cc_test {
...
googletest-param-test-test_ndk = cc_test {
...
gtest-typed-test_test_ndk = cc_test {
...
in { inherit googletest-param-test-test googletest-param-test-test_ndk gtest-typed-test_test gtest-typed-test_test_ndk gtest_ndk_test_defaults gtest_ndk_tests gtest_ndk_tests_no_main gtest_prod_test gtest_prod_test_ndk gtest_test_defaults gtest_tests gtest_tests_no_main; }
