{ cc_defaults, cc_library_static, cc_test, cc_test_library }:
let

fluoride_osi_defaults = cc_defaults {
...
#  ========================================================
libosi-AllocationTestHarness = cc_test_library {
...
libosi-AlarmTestHarness = cc_test_library {
...
in { inherit fluoride_osi_defaults libosi libosi-AlarmTestHarness libosi-AllocationTestHarness net_test_osi; }
