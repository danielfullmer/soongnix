...
ExperimentalCarService = android_app {
...
# ####################################################################################
experimentalcar-service-test-static-lib = android_library {
...
in { inherit ExperimentalCarService experimentalcar-service-test-static-lib; }
