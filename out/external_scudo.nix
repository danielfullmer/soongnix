...
libscudo = cc_library_static {
    name = "libscudo";
    defaults = ["libscudo_defaults"];
    cflags = ["-D_BIONIC=1"];
};

libscudo_for_testing = cc_library_static {
    name = "libscudo_for_testing";
    defaults = ["libscudo_defaults"];
};

scudo_unit_tests = cc_test {
...
in { inherit libscudo libscudo_defaults libscudo_for_testing scudo_unit_tests; }
